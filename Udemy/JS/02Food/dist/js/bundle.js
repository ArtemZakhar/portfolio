  ...
  function getDynamicInformation(selector) {
    ...
    input.addEventListener('input', () => {
      if (input.value.match(/\D/g)) {
        input.style.border = '1px solid rgb(247, 104, 47)';
      } else {
        input.style.border = '1px solid rgb(125, 240, 31)';
      }
...
function cards() {
  ...
  Object(_services_services_js__WEBPACK_IMPORTED_MODULE_0__["getResource"])('http://localhost:3000/menu').then(data => {
    data.forEach(_ref => {
      let {
        img,
        altimg,
...
function forms(formSelector, modalTimerId) {
  ...
  function bindPostData(form) {
    form.addEventListener('submit', e => {
      ...
      const json = JSON.stringify(Object.fromEntries(formData.entries())); // const object = {};
...
function slider(_ref) {
  ...
  prev.addEventListener('click', () => {
    if (offset == 0) {
      offset = deleteNotDigits(width) * (slides.length - 1); // offset = +width.slice(0, width.length - 2) * (slides.length -1);
    } else {
...
/* harmony import */ var _modules_slider_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/slider.js */ "./js/modules/slider.js");
...
window.addEventListener('DOMContentLoaded', () => {
  const modalTimerId = setTimeout(() => Object(_modules_modal_js__WEBPACK_IMPORTED_MODULE_2__["openModal"])('.modal', modalTimerId), 500000);
  Object(_modules_tabs_js__WEBPACK_IMPORTED_MODULE_1__["default"])('.tabheader__item', '.tabcontent', '.tabheader__items', 'tabheader__item_active');
  Object(_modules_modal_js__WEBPACK_IMPORTED_MODULE_2__["default"])('[data-modal]', '.modal', modalTimerId);
  Object(_modules_timer_js__WEBPACK_IMPORTED_MODULE_3__["default"])('.timer', '2022-12-01');
  ...
  Object(_modules_forms_js__WEBPACK_IMPORTED_MODULE_6__["default"])('form', modalTimerId);
  Object(_modules_slider_js__WEBPACK_IMPORTED_MODULE_7__["default"])({
