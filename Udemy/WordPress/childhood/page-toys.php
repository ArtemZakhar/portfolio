    ...
    <div class="row">
      <div class="col-lg-10 offset-lg-1">
        <div class="toys__alert">
          <span>Не знайшли бажаного?</span> Зв'яжіться з нами зручним для вас способом - і ми залюбки створимо бажану вами іграшку. Ви маєте змогу обрати усе: розмір, матеріал, форми...!
        </div>
      </div>
    </div>
  </div>
