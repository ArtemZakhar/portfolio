<div class="question">
            <div class="question__text">
                Лишились питання? Напишіть нам!
            </div>
            <div id="reply" class="minibutton">Написати</div>
        ...
        <div class="reply">
            <div class="reply__body">
                <div class="reply__title">
                    Лишіть ваше питання тут
                </div>
                <div>
                    <?php echo do_shortcode('[contact-form-7 id="139" title="Лишити запитання"]'); ?>
