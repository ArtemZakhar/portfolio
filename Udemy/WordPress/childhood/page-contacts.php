<?php 
/*
Template Name: Контакти і відгуки
*/
?>
    ...
    <div class="row">
      <div class="col-lg-6">
        <div class="contacts__descr underlined">
          Ми знаходимось в Київській області, поруч зі столицею
          <br> <br>
          за адресою <?php the_field('address', 2); ?>
        </div>
      </div>
        <div class="col-lg-6">
          <div class="contacts__map">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d522.4167840872705!2d30.7758516324291!3d50.12625847919544!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x40d4919c4f3df761%3A0x7f7e96e7b70a5b27!2z0J_QsNC8J9GP0YLQvdC40Log0JTQsNC90LjQu9GDINCi0LXRgNC_0LjQu9C-KNCX0LXQu9C10L3QuNC5KQ!5e0!3m2!1suk!2sua!4v1671386745187!5m2!1suk!2sua" width="600" height="340" style="border:0;" allowfullscreen="true" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
          </div>
        </div>
    </div>
      <div class="row">
            ...
            <div class="contacts__phones">
              ...
              <div class="contacts__phoneblock">
                ...
                <div class="contacts__phonewrap">
                  ...
                  <a href="tel:<?php the_field('additional_tel', 2); ?>">+<?php the_field('additional_tel', 2); ?></a>
                </div>
              </div>
            </div>
        ...
        <div class="col-md-6">
          <div class="title contacts__minititle">Залиште ваш відгук</div>
          <div class="contacts__feed">
            <?php echo do_shortcode('[contact-form-7 id="138" title="форма відгуків"]'); ?>
