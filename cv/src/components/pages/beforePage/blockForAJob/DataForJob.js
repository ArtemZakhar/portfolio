...
const DataForJob = () => {
  ...
  const initialState = [
      ...
      position: 'Засновник, керівник оперативного відділу',
      ...
      terms: 'Жовтень 2011 - Листопад 2012', 
      time: '1 рік',
      place: 'Київ', 
      web: "/before", 
      ...
      achievements: ["-Змінив метод доставки товару, чим зменшим кількість пошкодженої продукції і оптимізував вартість доставки;", "-Відправив виставковий екземпляр в Польщу і повернув назад, зекономивши кошти на митне оформлення і вартість транспортування в зворотному напрямку;"],
      rise: false}
  ];
